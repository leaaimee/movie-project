...
def search_movie():
    ...
    if found_movies:
        ...
        print(error_color + f"This movie {search_title} is currently not in the database" + Style.RESET_ALL)


# Annotation to the Bonus Task "Fuzzy Matching": I explored this concept but prefer to wait until I fully understand the implementation and might add this section later
# and might add this section later
...
def sorted_by_rating():
    ...
    sorted_movies = movie_storage.sorted_by_rating()
...
def main():
    ...
    while True:
        ...
        print(menu_color + "10.  Create Rating Histogram" + Style.RESET_ALL)
